...
#define Tn1INT1(d1,m1)       memset((d1),       -1, sizeof(INT)*(m1))
...
/*Z set the size of INT for Y3D (BIG_INT=64, !BIG_INT=32)
#define BIG_INT
*/
#include <limits.h>
#if   ( defined(BIG_INT) && (LONG_MAX == INT_MAX)) /* Windows32/64 or Linux32 INT=64 */
# define USE_LONG_LONG
#elif (!defined(BIG_INT) && (LONG_MAX == INT_MAX)) /* Windows32/64 or Linux32 INT=32 */
# define USE_LONG
#elif ( defined(BIG_INT) && (LONG_MAX  > INT_MAX)) /* Linux64                 INT=64 */
# define USE_LONG
#elif (!defined(BIG_INT) && (LONG_MAX  > INT_MAX)) /* Linux64                 INT=32 */
# define USE_INT
#else                                            /* unknown INT specification      */
...
/*Z issue - long is inconsistent size across platforms
#define INT long
#define INT int
*/
...
#define EPSILON1 1.0e-15
//#define EPSILON1 1.0e-25
#define BEPSILON 1.0e+25
#define NEPSILON -1.0e-25
#define NEPSILON1 -1.0e-15
//#define NEPSILON1 -1.0e-25
#define R0 0.0
#define R1 1.0
#define R2 2.0
#define R3 3.0
...
/*Z issue - %ld means long, whereas we have switched to sized integers
*/
/*
static CHR *INT_S[20]=
{
...
#define INT_SR   "%ld"
*/
/*Z set the format strings for INT
*/
#if defined(USE_LONG_LONG)
  static CHR *INT_S[20]=
  {
      "%lld", "%1lld", "%2lld", "%3lld", "%4lld", "%5lld", "%6lld", "%7lld", "%8lld", "%9lld",
    "%10lld","%11lld","%12lld","%13lld","%14lld","%15lld","%16lld","%17lld","%18lld","%19lld"
  };
# define INT_SR "%lld"
#elif defined(USE_LONG)
  static CHR *INT_S[20]=
