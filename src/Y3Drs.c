...
{ INT icount,jcount;
  ...
  CHRw(fout,"/YD/YDI/DRECT");
  CHRwsp(fout);
  DBLw(fout,ydi->drect,18);
  CHRwcr(fout);
  ...
  CHRwcr(fout);
    ...
    {
        INTw(fout,ydi->i1stat[icount],10);
        CHRwsp(fout);
    }
    CHRwcr(fout);
...
{ INT icount,jcount;
  ...
  CHRwcr(fout);
    ...
    for(icount=0;icount<ydn->nnopo;icount++)
    { for(jcount=0;jcount<ydn->nnodim;jcount++)
    { DBLw(fout,ydn->d2nck[jcount][icount],19);
        CHRwsp(fout);
    }
        CHRwcr(fout);
    }
...
{ INT icount,jcount;
  ...
  for(icount=0;icount<yde->nelemi;icount++)
  {
   INTw(fout,icount+1,5);
   CHRwsp(fout);
   for(jcount=0;jcount<yde->nelno-1;jcount++)
   {
...
/****************** Super particle **************************************/
static void Ywsp(ysp,ydn,fout)
YSP ysp; FILE *fout; YDN ydn;
{ INT icount,jcount;
	
	CHRw(fout,"     /*   Super particle     */");
	CHRwcr(fout);
	CHRw(fout,"/YD/YSP/MSPD");
	CHRwsp(fout);
	INTw(fout,ysp->mspd,5);
	CHRwcr(fout);

	CHRw(fout,"/YD/YSP/NSPD");
	CHRwsp(fout);
	INTw(fout,ysp->nspd,5);
	CHRwcr(fout);

        CHRw(fout,"/YD/YSP/I1CON");
        CHRwsp(fout);
        INTw(fout,ysp->nspd,5);
        CHRwcr(fout);
        for(icount=0;icount<ysp->nspd;icount++)
        { INTw(fout,ysp->i1con[icount],8);
                CHRwsp(fout);
        }
        CHRwcr(fout);

	CHRw(fout,"/YD/YSP/D1MASS");
	CHRwsp(fout);
	INTw(fout,ysp->nspd,5);
	CHRwcr(fout);
	for(icount=0;icount<ysp->nspd;icount++)
	{ DBLw(fout,ysp->d1mass[icount],18);
		CHRwsp(fout);
	}
	CHRwcr(fout);	
	
	CHRw(fout,"/YD/YSP/D2PP");
	CHRwsp(fout);
	INTw(fout,21,5);
	CHRwsp(fout);
	INTw(fout,ydn->nnodim,5);
	...
	for(icount=0;icount<ysp->nspd;icount++)
	{ for(jcount=0;jcount<ydn->nnodim;jcount++)
    { DBLw(fout,ysp->d2pp[jcount][icount],19);
		CHRwsp(fout);
    }
		CHRwcr(fout);
	}
	...
	for(icount=0;icount<ysp->nspd;icount++)
	{ for(jcount=0;jcount<ydn->nnodim;jcount++)
    { DBLw(fout,ysp->d2pvt[jcount][icount],19);
		CHRwsp(fout);
    }
		CHRwcr(fout);
	}
	...
	for(icount=0;icount<ysp->nspd;icount++)
	{ for(jcount=0;jcount<ydn->nnodim;jcount++)
    { DBLw(fout,ysp->d2pa[jcount][icount],19);
		CHRwsp(fout);
    }
		CHRwcr(fout);
	}
	...
	for(icount=0;icount<ysp->nspd;icount++)
	{ for(jcount=0;jcount<ydn->nnodim;jcount++)
    { DBLw(fout,ysp->d2pvr[jcount][icount],19);
		CHRwsp(fout);
    }
		CHRwcr(fout);
	}
	...
	for(icount=0;icount<ysp->nspd;icount++)
	{ for(jcount=0;jcount<ydn->nnodim;jcount++)
    { DBLw(fout,ysp->d2prine[jcount][icount],19);
		CHRwsp(fout);
    }
		CHRwcr(fout);
	}
	...
	for(icount=0;icount<ysp->nspd;icount++)
	{ for(jcount=0;jcount<ydn->nnodim;jcount++)
    { DBLw(fout,ysp->d2prinn1[jcount][icount],19);
		CHRwsp(fout);
    }
		CHRwcr(fout);
	}
	...
	for(icount=0;icount<ysp->nspd;icount++)
	{ for(jcount=0;jcount<ydn->nnodim;jcount++)
    { DBLw(fout,ysp->d2prinn2[jcount][icount],19);
		CHRwsp(fout);
    }
		CHRwcr(fout);
	}
	...
	for(icount=0;icount<ysp->nspd;icount++)
	{ for(jcount=0;jcount<ydn->nnodim;jcount++)
    { DBLw(fout,ysp->d2prinn3[jcount][icount],19);
		CHRwsp(fout);
    }
		CHRwcr(fout);
	}
...
{ INT icount;
	...
	CHRwcr(fout);
    CHRw(fout,"/YD/YDX/MELEM");
	CHRwsp(fout);
	INTw(fout,ydx->melem_t,6);
	CHRwcr(fout);
	CHRw(fout,"/YD/YDX/NELEM");
	CHRwsp(fout);
	INTw(fout,ydx->nelem_t,6);
	CHRwcr(fout);
	...
	for(icount=0;icount<ydx->nelem_t;icount++)
	{ for(jcount=0;jcount<ydx->nelno;jcount++)
    {
        INTw(fout,ydx->i2elto_t[icount][jcount],6);
		CHRwsp(fout);
    } 
		CHRwcr(fout);
	}
...
Ywsp(ysp,ydn,fp);     /* Write superparticle variables into the input file   */
